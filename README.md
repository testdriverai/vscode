...
[Docs](https://docs.testdriver.ai) | [Website](https://testdriver.ai) | [Discord](https://discord.com/invite/cWDFW8DzPm)
...
4. Install the MCP server via Command Palette: **TestDriver: Install MCP Server**
5. Run a test with `preview: "ide"` to see live execution
